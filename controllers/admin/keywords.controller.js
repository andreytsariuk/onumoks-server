    ...
    */
    static Post(req, res, next) {
        return new Keywords({
            ...
            .save()
            .then(newKeyword => res.status(201).send(newKeyword))
            .catch(next);
    }
    ...
    static Get(req, res, next) {
        return res.status(200).send(req.requestedKeyword);
    }
    ...
    static Put(req, res, next) {
        return req.requestedKeyword
            .save(req.body)
            .then(keyword => res.status(200).send(req.requestedKeyword))
            .catch(next);
    }
    /**
     * Delete Current User
